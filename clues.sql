...
--returned list of countries with Holy See (Vatican City State) as country with lowest population


-- Clue #2: Now that we're here, we have insight that Carmen was seen attending language classes in this country's officially recognized language. Check our databases and find out what language is spoken in this country, so we can call in a translator to work with you.

SELECT countries.code AS code, countrylanguages.language AS language FROM countries JOIN countrylanguages ON countries.code = countrylanguages.countrycode AND countries.name = 'Holy See (Vatican City State)' AND countrylanguages.isofficial = TRUE;

--returned Italian as the Holy See's official language
